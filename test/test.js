var contract = require("@truffle/contract"); //“@truffle/contract”: “^4.1.6",
var datta = require("@gnosis.pm/dex-contracts/build/contracts/BatchExchange");
var BatchExchange = contract(datta);

const ERC20Mintable = artifacts.require("ERC20Mintable")

//const GnosisSafe = artifacts.require("GnosisSafe")
datta = require("@gnosis.pm/safe-contracts/build/contracts/GnosisSafe");
var GnosisSafe = contract(datta);

//const ProxyFactory = artifacts.require("ProxyFactory")
datta = require("@gnosis.pm/safe-contracts/build/contracts/ProxyFactory");
var ProxyFactory = contract(datta);
//const MultiSend = artifacts.require('MultiSend')
datta = require("@gnosis.pm/safe-contracts/build/contracts/MultiSend");
var MultiSend = contract(datta);
...
let encodeData = function(operation, to, value, data) {
  ...
  contract("BatchExchangeInterface", async accounts => {
